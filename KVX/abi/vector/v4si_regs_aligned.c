...
int check_args_are_correct_user(v4si a01, v4si a23, int a4, int a5, v4si a67,
                                v4si a89, v4si a1011, int s0, int s1) {
  return a01[0] == 0 && a01[1] == 0 && a01[2] == 1 && a01[3] == 1 &&
         a23[0] == 2 && a23[1] == 2 && a23[2] == 3 && a23[3] == 3 && a4 == 4 &&
         a5 == 5 && a67[0] == 6 && a67[1] == 6 && a67[2] == 7 && a67[3] == 7 &&
