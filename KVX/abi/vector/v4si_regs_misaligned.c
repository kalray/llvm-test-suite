...
int check_args_are_correct(int a0, v4si a12, v4si a34, int a5, v4si a67, int a8,
                           int a9, int a10, int a11, v4si s01, int s02,
                           int s03);

int check_args_are_correct_user(int a0, v4si a12, v4si a34, int a5, v4si a67,
