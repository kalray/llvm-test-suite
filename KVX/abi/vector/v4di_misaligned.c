...
int check_args_are_correct_user(int a0, v4di_t a1234, int a5, v4di_t a6789,
                                v4di_t a1011s01, v4di_t s1234) {
  return a0 == 0 && a1234[0] == 1 && a1234[1] == 2 && a1234[2] == 3 &&
         ...
         s1234[0] == 14 && s1234[1] == 15 && s1234[2] == 16 && s1234[3] == 17;
}
...
int main(int argc, char **argv) {
  ...
  // CHECK_STACK 0:8 0x000000000000000C
  // CHECK_STACK 8:8 0x000000000000000D

  // CHECK_STACK 16:8 0x000000000000000E
  // CHECK_STACK 24:8 0x000000000000000F
  // CHECK_STACK 32:8 0x0000000000000010
  // CHECK_STACK 40:8 0x0000000000000011
