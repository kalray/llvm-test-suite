...
int check_args_are_correct_user(int a0, __int128 argument1_2,
                                ...
                                int argument11) {
  return a0 == 0 &&
         argument1_2 == ((unsigned __int128)0xdeadbeef12345678ULL)SHIFT_64 +
                            0xABCDEF9955555555ULL &&
         argument3_4 == ((unsigned __int128)0xdeadbeef12345678ULL)SHIFT_64 +
                            0xABCDEF9955555555ULL &&
         argument5 == 5 && argument6 == 6 && argument7 == 7 &&
         argument8_9 == ((unsigned __int128)0xdedebeef12345678ULL)SHIFT_64 +
                            0xABCDEF9955555555ULL &&
