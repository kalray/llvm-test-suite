...
int check_args_are_correct_user(int a0, int a1, __int128 argument2_3,
                                __int128 argument4_5, int argument6,
  ...
  return a0 == 0 && a1 == 1 &&
         ...
         argument4_5 == ((unsigned __int128)0xdeadbeef12345678ULL)SHIFT_64 +
                            0xABCDEF9955555555ULL &&
