...
int check_args_are_correct(int argument0, int lastnamed, ...) {
  ...
  if (va_arg_var_0 != (((unsigned __int128)0xdeaddead12345678ULL)SHIFT_64 +
  ...
  if (va_arg_var_1 != (((unsigned __int128)0xdeadbeef12345678ULL)SHIFT_64 +
  ...
  if (va_arg_var_2 != (((unsigned __int128)0xbeefbeef12345678ULL)SHIFT_64 +
  ...
  if (va_arg_var_5 != (((unsigned __int128)0xdeadeade12345678ULL)SHIFT_64 +
...
int check_args_are_correct_user(int argument0, int lastnamed, ...) { return 1; }
